 ...
 */
public class PinRequestHandlerMockCancelPoster {
    private static final Logger LOG = LoggerFactory.getLogger(PinRequestHandlerMockCancelPoster.class);
    ...
    public PinRequestHandlerMockCancelPoster() {
    }
     ...
     */
    public PinRequestHandlerMockCancelPoster(final String[] getPinStatusRequestResponse, final String[] verifyRequestResponse) {
    ...
    public void handlePinNumber(final RequestPinNumberEvent event) {
        ...
        cancelVerify(event, pinType);

    }

    private void cancelVerify(final RequestPinNumberEvent event, final String pinType) {
        EventBus.getDefault().post(new CancelEvent(event, pinType));
    }
